...
/**
 * Quadtree-based implementation of a PointSet2D, a collection
 * of points in two dimensions.
 * 
 * @author Jim Teresco
 * @version Spring 2022
 */
public class Quadtree<E extends Point2D.Double> implements PointSet2D<E> {
	...
	protected boolean isLeaf() {
		...
		// in a leaf, all 4 children are null (only need to check one)
		return se == null;
	}
